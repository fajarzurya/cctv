    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart('instalasi/tambah_daftar');?>
						...
						<!-- /.box-header -->
						  <div class="box-body">
							<div class="col-xs-3 form-group">
							  ...
							  <input type="text" class="form-control" name="id_instalasi" placeholder="Nomor Instalasi" readonly value=<?php echo $kode_instalasi;?>>
							</div>
							<div class="col-xs-6 form-group">
							  <label>Deskripsi</label>
							  <input type="text" class="form-control" style="text-transform:uppercase;" name="deskripsi" placeholder="Deskripsi Instalasi">
							</div>
							<div class="col-xs-2 form-group">
							  <label>Status</label>
							  <input type="text" class="form-control" name="status" placeholder="Status" value="Aktif" readonly>
							</div>
							...
							<div class="col-xs-3 form-group">
								...
								<div class="input-group">
								  <input type="text" name="pelanggan" id="set1" class="form-control" placeholder="Pelanggan" readonly>
							...
							<div class="col-xs-3 form-group">
							  ...
							  <select class="form-control" name="jenis">
								  <option selected="selected">Beli</option>
								  <option>Sewa</option>
							  </select>
							</div>
							<div class="col-xs-2 form-group">
							...
							<div class="col-xs-3 form-group">
							  ...
							  <div class="input-group">
								  <input type="text" class="form-control" id="set2" name="pelaksana" placeholder="Pelaksana" readonly>
								  <span class="input-group-addon"><i class="fa fa-plus"></i></span>
							  </div>
							</div>							
							<div class="col-xs-3 form-group">
							...
							<div id="collapse2" class="panel-collapse collapse">
							  ...
							  <div class="col-xs-4 form-group">
								...
								<div class="input-group date">
								  <input type="text" class="form-control pull-right" id="datepicker2" name="tglselesai">
								  <div class="input-group-addon">
									<i class="fa fa-calendar"></i>
								  </div>
								</div>
