...
<div style="margin-left:8%;width:100%;margin-top:5%">
	<div class="row-fluid">
       ...
       <div class="panel50kr" style="padding:10px;float:left;width:40%">
            ...
            <span style="color:#666;font-size:12px;margin-top:-20px;">Periksa alamat url website anda.</span>
            <br><br><br>
            </div>
            <div class="clear"></div>
            <div style="padding:10px;text-align:left;">
                ...
                <br><br>
                <ol>
					<li>Anda salah mengetik alamat website.</li>
                    <li>Website sedang dalam perbaikan.</li>
                </ol>
            </div>
            <div class="clear"></div>
       ...
       <div class="panel50kr" style="padding:10px;float:left;width:40%;">
            ...
            <div style="padding:5px;">
            	<img src="<?php echo base_url();?>asset/images/notfound.jpg" alt="under construction"/>
            </div>
